  ...
  return (
    <main className="flex-1 flex flex-col items-center px-4 py-10 sm:py-14">
      <div className="w-full max-w-4xl">
        ...
        <div className="mb-2">
          <Banner art={BANNER_INSPECT} label="inspect" />
        </div>
        <p className="text-dim text-sm mb-10">everything moving through the wire, all at once.</p>

        <Frame title="inspect" tone="problem">
          {!loaded ? (
